...
//Salva uma lista do produtos 
    public boolean salvarVendasProdutosDAO(ArrayList<ModelVendasProdutos> plistaVendasProdutoses) {
                try {
            this.conectar();
            int cont = plistaVendasProdutoses.size();
            ...
            this.insertSQL(
                "INSERT INTO tbl_vendas_produtos ("
                    ...
                    + "ven_pro_quantidade"
                + ") VALUES ("
                    + "'" + plistaVendasProdutoses.get(i).getProduto()+ "',"
                    + "'" + plistaVendasProdutoses.get(i).getVendas() + "',"
                    + "'" + plistaVendasProdutoses.get(i).getVenProValor() + "',"
                    + "'" + plistaVendasProdutoses.get(i).getVenProQuantidade() + "'"
                + ");"
            );
         } 
           return true;
